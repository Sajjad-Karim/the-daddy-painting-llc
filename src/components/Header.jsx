...
const Header = () => {
  ...
  return (
    <header className="w-full">
      ...
      {isMenuOpen && (
        <div
          className="fixed inset-0 z-50 flex bg-white md:bg-transparent"
          role="dialog"
          aria-modal="true"
        >
          {/* Left image panel */}
          ...
          <div className="flex w-full flex-col justify-between bg-[#2D2928] px-6 py-6 text-white md:w-1/2 md:px-10 md:py-10">
            ...
            <div className="mt-10 flex flex-1 flex-col items-center justify-center gap-10">
                ...
                {["ABOUT US", "SERVICES", "WHY CHOOSE US", "GALLERY"].map(
                  (menuLabel) => (
                    <button
                      key={menuLabel}
                      type="button"
                      className='text-4xl font-extrabold uppercase tracking-[0.18em] text-white hover:text-[#A1F88B] cursor-pointer font-["Inter"]'
                    >
                      {menuLabel}
                    </button>
                  )
